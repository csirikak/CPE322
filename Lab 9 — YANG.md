...
```
C:\Users\n_j\Downloads\iot-master\lesson9> pip install pyang plantuml six
```
### Prepare and View Files
```
mkdir ~/demo
cp ~/iot/lesson9/intrusiondetection.yang ~/demo
cd ~/demo
notepad intrusiondetection.yang
```
### Contents of intrusiondetection.yang
```
...
```
### Prepare intrusiondetection.yin
```
pyang -f yin -o intrusiondetection.yin intrusiondetection.yang
notepad intrusiondetection.yin
```
### Contents of intrusiondetection.yin
```
...
```
### Prepare intrusiondetection.uml
```
pyang -f uml -o intrusiondetection.uml intrusiondetection.yang --uml-no=stereotypes,annotation,typedef
notepad intrusiondetection.uml
```
### Contents of intrusiondetection.uml
```
...
center footer
 <size:20> UML Generated : 2023-04-03 11:01 </size>
 endfooter 
@enduml 
```
### Prepare PNG file
...
```
![intrusiondetection](https://user-images.githubusercontent.com/32028457/229549745-e78bb30b-0c3a-4cf8-b04c-562a0838f179.png)
